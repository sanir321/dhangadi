                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-4 lg:sticky lg:top-32 h-fit">
                        <div className="glass-card relative overflow-hidden group">
                            ...
                            <h1 className="text-4xl font-black tracking-tighter mb-4 uppercase">{game.name}</h1>
                            <p className="text-white/40 mb-10 font-medium leading-relaxed italic">"{game.description}"</p>
                    ...
                    <div className="lg:col-span-8 space-y-10">
                        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                            <div>
                                <h2 className="text-3xl font-black tracking-tighter uppercase mb-2">Select <span className="text-accent">Package</span></h2>
                                ...
                                >
                                    <div className="flex items-start justify-between">
                                        <div className="text-left">
                                            <p className="font-black text-2xl tracking-tight mb-1 group-hover:text-accent transition-colors">{pkg.label}</p>
                                    ...
                                    <div className="flex items-end justify-between mt-auto">
                                        <div className="flex flex-col">
                                            ...
                                            <p className="text-accent font-black text-3xl tracking-tight">NPR {pkg.price}</p>
                                        </div>
                        ...
                        <div className="glass-card !bg-accent/5 border border-accent/20 p-10 mt-16 group cursor-pointer relative overflow-hidden">
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                                <div className="text-center md:text-left">
                                    <h3 className="text-3xl font-black tracking-tighter uppercase mb-4">Don't see your desired amount?</h3>
                                    <p className="text-white/50 text-lg font-medium max-w-lg leading-relaxed">
                                ...
                                <a 
                                    href="https://wa.me/97797XXXXXXX" 
                                    target="_blank" 
                                    rel="noopener noreferrer"
                                    className="bg-accent text-black font-black py-6 px-12 rounded-[2rem] hover:scale-105 active:scale-95 transition-all shadow-2xl shadow-accent/20 text-lg uppercase tracking-widest whitespace-nowrap"
                                >
                                    Chat on WhatsApp
                                </a>
                            </div>
